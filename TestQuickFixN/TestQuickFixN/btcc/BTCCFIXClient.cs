...
namespace TestQuickFixN.btcc
{
	class MainClass
	{
		public static void Main (string[] args)
		{
            ...
            string sessionFile = UtilString.path_btcc + "session_client.txt";
	...
	class BTCCFIXClientApp : MessageCracker, IApplication
	{
		...
		public void FromApp(QuickFix.Message msg, SessionID sessionID) { 
			...
			{
				Crack(msg, sessionID);
                Console.WriteLine("Crack(msg, sessionID)");
			}
			catch (Exception ex)
			{
	...
	class FIX44XMLParser{
		public string getFieldName(string tag){
            ...
            doc.Load(UtilString.path_btcc + "FIX44.xml");
